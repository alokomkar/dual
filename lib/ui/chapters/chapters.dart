class Chapter {
  ...
  static List<Chapter> getChaptersByTitle(String title) {
    Map<String, List<Chapter>> chaptersMap = getAllChapters();
    return chaptersMap[title];
  }
  ...
  static Map<String, List<Chapter>> getAllChapters() {
    ...
    chaptersList
        .add(Chapter("", chapterTitle, "The Java Programming Language"));
    ...
    chaptersList.add(
        Chapter("", chapterTitle, "Questions and Exercises: Getting started"));
    ...
    chaptersList.add(Chapter("", chapterTitle,
    ...
    chaptersList
        .add(Chapter("", chapterTitle, "Questions and Exercises: Variables"));
    chaptersMap[chapterTitle] = chaptersList;

    chaptersList = new List();
    chapterTitle = "Operators";
    chaptersList.add(Chapter(
        "", chapterTitle, "Assignment, Arithmetic, and Unary Operators"));
    chaptersList.add(Chapter(
        "", chapterTitle, "Equality, Relational, and Conditional Operators"));
    chaptersList
        .add(Chapter("", chapterTitle, "Bitwise and Bit Shift Operators"));
    chaptersList.add(Chapter("", chapterTitle, "Summary of Operators"));
    chaptersList
        .add(Chapter("", chapterTitle, "Questions and Exercises: Operators"));
    chaptersList
        .add(Chapter("", chapterTitle, "Expressions, Statements, and Blocks"));
    chaptersList.add(Chapter("", chapterTitle,
    ...
    chaptersList.add(
        Chapter("", chapterTitle, "The if-then and if-then-else Statements"));
    chaptersList.add(Chapter("", chapterTitle, "The switch Statement"));
    chaptersList
        .add(Chapter("", chapterTitle, "The while and do-while Statements"));
    chaptersList.add(Chapter("", chapterTitle, "The for Statement"));
    chaptersList.add(Chapter("", chapterTitle, "Branching Statements"));
    chaptersList
        .add(Chapter("", chapterTitle, "Summary of Control Flow Statements"));
    chaptersList.add(Chapter(
        "", chapterTitle, "Questions and Exercises: Control Flow Statements"));
    chaptersMap[chapterTitle] = chaptersList;
    ...
    chaptersList.add(
        Chapter("", chapterTitle, "Providing Constructors for Your Classes"));
    chaptersList.add(Chapter(
        "", chapterTitle, "Passing Information to a Method or a Constructor"));
    ...
    chaptersList
        .add(Chapter("", chapterTitle, "Returning a Value from a Method"));
    chaptersList.add(Chapter("", chapterTitle, "Using the this Keyword"));
    chaptersList.add(
        Chapter("", chapterTitle, "Controlling Access to Members of a Class"));
    ...
    chaptersList.add(Chapter(
        "", chapterTitle, "Summary of Creating and Using Classes and Objects"));
    chaptersList
        .add(Chapter("", chapterTitle, "Questions and Exercises: Classes"));
    chaptersList
        .add(Chapter("", chapterTitle, "Questions and Exercises: Objects"));
    chaptersMap[chapterTitle] = chaptersList;
    ...
    chaptersList.add(
        Chapter("", chapterTitle, "Questions and Exercises: Nested Classes"));
    chaptersList.add(Chapter("", chapterTitle, "Enum Types"));
    chaptersList
        .add(Chapter("", chapterTitle, "Questions and Exercises: Enum Types"));
    chaptersMap[chapterTitle] = chaptersList;
    ...
    chaptersList.add(Chapter(
        "", chapterTitle, "Type Annotations and Pluggable Type Systems"));
    chaptersList.add(Chapter("", chapterTitle, "Repeating Annotations"));
    chaptersList
        .add(Chapter("", chapterTitle, "Questions and Exercises: Annotations"));
    ...
    chaptersList
        .add(Chapter("", chapterTitle, "Questions and Exercises: Interfaces"));
    chaptersMap[chapterTitle] = chaptersList;
    ...
    chaptersList
        .add(Chapter("", chapterTitle, "Overriding and Hiding Methods"));
    ...
    chaptersList
        .add(Chapter("", chapterTitle, "Writing Final Classes and Methods"));
    ...
    chaptersList
        .add(Chapter("", chapterTitle, "Questions and Exercises: Inheritance"));
    chaptersMap[chapterTitle] = chaptersList;
    ...
    chaptersList.add(
        Chapter("", chapterTitle, "Converting Between Numbers and Strings"));
    chaptersList
        .add(Chapter("", chapterTitle, "Manipulating Characters in a String"));
    chaptersList.add(
        Chapter("", chapterTitle, "Comparing Strings and Portions of Strings"));
    chaptersList.add(Chapter("", chapterTitle, "The StringBuilder Class"));
    chaptersList
        .add(Chapter("", chapterTitle, "Summary of Characters and Strings"));
    chaptersList.add(Chapter("", chapterTitle, "Autoboxing and Unboxing"));
    chaptersList.add(Chapter(
        "", chapterTitle, "Questions and Exercises: Characters and Strings"));
    chaptersMap[chapterTitle] = chaptersList;
    ...
    chaptersList.add(Chapter(
        "", chapterTitle, "Generic Methods and Bounded Type Parameters"));
    chaptersList
        .add(Chapter("", chapterTitle, "Generics, Inheritance, and Subtypes"));
    ...
    chaptersList
        .add(Chapter("", chapterTitle, "Wildcard Capture and Helper Methods"));
    ...
    chaptersList
        .add(Chapter("", chapterTitle, "Managing Source and Class Files"));
    chaptersList.add(
        Chapter("", chapterTitle, "Summary of Creating and Using Packages"));
    chaptersList.add(Chapter("", chapterTitle,
  ...
  static Map<String, String> getAllChaptersSummary(
